        ...
        builder: (context, Setting _setting, _) {
          return MaterialApp(
              ...
              theme: _setting.brightness.value == Brightness.light
                ...
                focusColor: config.Colors().accentColor(1), // Optional, not in ThemeData anymore
                hintColor: config.Colors().secondColor(1), // Consider using inputDecorationTheme instead
                textTheme: const TextTheme(
                  // You had repeated headlineSmall; we keep one and rename appropriately
                  headlineSmall: TextStyle(fontSize: 20.0, height: 1.35, fontWeight: FontWeight.w600),
                  headlineMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600, height: 1.35),
                  headlineLarge: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w700, height: 1.35),
                  titleLarge: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w300, height: 1.5),
                  titleMedium: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, height: 1.35),
                ...
                textTheme: const TextTheme(
                  headlineSmall: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w600, height: 1.35),
                  headlineMedium: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w600, height: 1.35),
                  headlineLarge: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w700, height: 1.35),
                  titleLarge: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w300, height: 1.5),
                  titleMedium: TextStyle(fontSize: 15.0, fontWeight: FontWeight.w500, height: 1.35),
                  titleSmall: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w600, height: 1.35),
                  bodySmall: TextStyle(fontSize: 12.0, height: 1.35),
                  bodyLarge: TextStyle(fontSize: 14.0, height: 1.35),
                  labelSmall: TextStyle(fontSize: 12.0, height: 1.35),
                ).apply(
