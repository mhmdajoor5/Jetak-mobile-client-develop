...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/PaymentMethod':
        return MaterialPageRoute(builder: (_) => PaymentMethodsWidget(routeArgument: args));
      case '/DeliveryAddresses':
        return MaterialPageRoute(builder: (_) => DeliveryAddressesWidget(shouldChooseDeliveryHere: args as bool));
      case '/DeliveryPickup':
      ...
      case '/iCredit':
        return MaterialPageRoute(builder: (_) => ICreditPaymentWidget(routeArgument: args));
      case '/add_new_card':
