                    ...
                    children: <Widget>[
                                ...
                                child: Chip(
                                  ...
                                  label: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Icon(Icons.star_border, color: Theme.of(context).primaryColor, size: 30),
                                    ],
                                  ),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            Text(S.of(context).how_would_you_rate_this_restaurant_, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium),
                            SizedBox(height: 10),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: List.generate(5, (index) {
                                return InkWell(
                                  ...
                                  child:
                                      index < int.parse(_con.restaurantReview.rate)
                            ...
                            TextButton(
                              child: Row(
                                children: [
                                  ...
                                  SizedBox(width: 8),
                                  Text(S.of(context).submit, style: TextStyle(color: Theme.of(context).primaryColor)),
                                ],
                              ),
                        ...
                        children: List.generate(_con.foodsOfOrder.length, (index) {
                          return Container(
                            ...
                            child: Column(
                              ...
                              mainAxisSize: MainAxisSize.max,
                              children: <Widget>[
                                Text(_con.foodsOfOrder[index].name, textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium),
                                SizedBox(height: 10),
                                Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
                                  children: List.generate(5, (star) {
                                    return InkWell(
                                      ...
                                      child:
                                          star < int.parse(_con.foodsReviews[index].rate)
                                              ? Icon(Icons.star, size: 40, color: Color(0xFFFFB24D))
                                              : Icon(Icons.star_border, size: 40, color: Color(0xFFFFB24D)),
                                    );
                                  }),
