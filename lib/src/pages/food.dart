                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ListTile(
                              ...
                              title: Text(S.of(context).extras,
                                  style: Theme.of(context)
                                      .textTheme
                                      .titleMedium),
                              subtitle: Text(
                            ...
                            if (_con.food.extraGroups == null)
                              ...
                              ..._con.food.extraGroups.map((group) {
                                var extras = _con.food.extras
                                    .where((e) =>
                                e.extraGroupId == group.id)
                                    .toList();
                                int selectedCount = selectedExtras
                                    .where((id) => extras
                                    .any((e) => e.id == id))
                                    .length;
                                ...
                                return Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: 5),
                                    ...extras.map((extra) {
                                      bool isSelected = selectedExtras
                                          .contains(extra.id);
