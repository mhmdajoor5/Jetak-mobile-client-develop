            ...
            child: Column(
              ...
              children: [
                            ...
                            InkWell(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Expanded(
                                    child: Text(
                                      _con.currentLocationName == null
                                          ? S.of(context).choose_your_location
                                          : _con.currentLocationName.toString(),
                                      maxLines: 1,
                ...
                ...List.generate(settingsRepo.setting.value.homeSections.length, (
                  ...
                  String _homeSection = settingsRepo.setting.value.homeSections
                      .elementAt(index);
                  switch (_homeSection) {
                    case 'slider':
                    ...
                    case 'trending_week_heading':
                      return ListTile(
                        ...
                        subtitle: Text(
                          ...
                          style: Theme.of(
                            context,
                          ).textTheme.bodySmall?.copyWith(fontFamily: 'Nunito'),
                        ),
                      );
