...
class PermissionDeniedWidget extends StatefulWidget {
  PermissionDeniedWidget({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          MaterialButton(
            ...
            shape: StadiumBorder(),
            child: Text(S.of(context).login, style: Theme.of(context).textTheme.headlineSmall?.merge(TextStyle(color: Theme.of(context).scaffoldBackgroundColor))),
          ),
          SizedBox(height: 20),
          MaterialButton(
            elevation: 0,
            ...
            shape: StadiumBorder(),
            child: Text(S.of(context).i_dont_have_an_account, style: TextStyle(color: Theme.of(context).focusColor)),
          ),
        ],
      ),
    );
