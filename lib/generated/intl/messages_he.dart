...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "already_logged_in": MessageLookupByLibrary.simpleMessage("אתה כבר מחובר"),
    ...
    "click_to_pay_with_your_mastercard": MessageLookupByLibrary.simpleMessage(
    ...
    "click_to_pay_with_your_visa_card": MessageLookupByLibrary.simpleMessage(
    ...
    "deliveryMethodNotAllowed": MessageLookupByLibrary.simpleMessage(
      "שיטת המשלוח אינה מורשת!",
    ),
    "delivery_address": MessageLookupByLibrary.simpleMessage("כתובת למשלוח"),
    "delivery_address_removed_successfully":
        MessageLookupByLibrary.simpleMessage("כתובת למשלוח הוסרה בהצלחה"),
    "delivery_addresses": MessageLookupByLibrary.simpleMessage("כתובות למשלוח"),
    "delivery_fee": MessageLookupByLibrary.simpleMessage("דמי משלוח"),
    "delivery_or_pickup": MessageLookupByLibrary.simpleMessage(
      "משלוח או איסוף",
    ),
    ...
    "discover__explorer": MessageLookupByLibrary.simpleMessage("גליה וחוקר"),
    ...
    "faqsRefreshedSuccessfuly": MessageLookupByLibrary.simpleMessage(
      "שאלות נפוצות רעננו בהצלחה",
    ),
    "favorite_foods": MessageLookupByLibrary.simpleMessage("מזונות מועדפים"),
    ...
    "favorites_refreshed_successfuly": MessageLookupByLibrary.simpleMessage(
      "המועדפים רעננו בהצלחה",
    ),
    "featured_foods": MessageLookupByLibrary.simpleMessage("מזונות מובחרים"),
    ...
    "food_categories": MessageLookupByLibrary.simpleMessage("קטגוריות מזונות"),
    ...
    "haveCouponCode": MessageLookupByLibrary.simpleMessage("יש לך קוד קופון?"),
    ...
    "hint_full_address": MessageLookupByLibrary.simpleMessage(
      "רחוב 12, עיר 21663, מדינה",
    ),
    "home": MessageLookupByLibrary.simpleMessage("בית"),
    "home_address": MessageLookupByLibrary.simpleMessage("כתובת בית"),
    "how_would_you_rate_this_restaurant": MessageLookupByLibrary.simpleMessage(
      "איך היית מדרג את המסעדה הזו?",
    ),
    "how_would_you_rate_this_restaurant_": MessageLookupByLibrary.simpleMessage(
      "איך היית מדרג את המסעדה הזו?",
    ),
    ...
    "i_forgot_password": MessageLookupByLibrary.simpleMessage("שכחתי סיסמה?"),
    "i_have_account_back_to_login": MessageLookupByLibrary.simpleMessage(
      "יש לי חשבון? חזרה להתחברות",
    ),
    ...
    "invalidCouponCode": MessageLookupByLibrary.simpleMessage(
      "קוד קופון לא תקין",
    ),
    ...
    "login_success": MessageLookupByLibrary.simpleMessage("התחברות הצליחה!"),
    "login_successful": MessageLookupByLibrary.simpleMessage("התחברה בהצלחה"),
    "login_with_apple": MessageLookupByLibrary.simpleMessage("התחבר עם אפל"),
    "login_with_facebook": MessageLookupByLibrary.simpleMessage(
      "התחבר עם פייסבוק",
    ),
    "login_with_google": MessageLookupByLibrary.simpleMessage("התחבר עם גוגל"),
    ...
    "makeItDefault": MessageLookupByLibrary.simpleMessage("הגדר כברירת מחדל"),
    ...
    "multirestaurants": MessageLookupByLibrary.simpleMessage("מסעדות מרובות"),
    ...
    "near_to_your_current_location": MessageLookupByLibrary.simpleMessage(
      "בקרבת מיקום הנוכחי שלך",
    ),
    "newMessageFrom": MessageLookupByLibrary.simpleMessage("הודעה חדשה מאת"),
    "new_address_added_successfully": MessageLookupByLibrary.simpleMessage(
      "כתובת חדשה התווספה בהצלחה",
    ),
    ...
    "no_stores_found": MessageLookupByLibrary.simpleMessage("לא נמצאו חנויות"),
    "notValidAddress": MessageLookupByLibrary.simpleMessage("כתובת לא תקפה"),
    ...
    "not_a_valid_date": MessageLookupByLibrary.simpleMessage("לא תאריך חוקי"),
    ...
    "not_a_valid_number": MessageLookupByLibrary.simpleMessage("לא מספר חוקי"),
    "not_a_valid_phone": MessageLookupByLibrary.simpleMessage(
      "מספר טלפון לא חוקי",
    ),
    "not_deliverable": MessageLookupByLibrary.simpleMessage("לא ניתן למשלוח"),
    ...
    "open_until": m1,
    "opened_restaurants": MessageLookupByLibrary.simpleMessage("מסעדות פתוחות"),
    "or_checkout_with": MessageLookupByLibrary.simpleMessage("או בצע הזמנה עם"),
    ...
    "payment_card_updated_successfully": MessageLookupByLibrary.simpleMessage(
      "כרטיס התשלום עודכן בהצלחה",
    ),
    "payment_mode": MessageLookupByLibrary.simpleMessage("אמצעי תשלום"),
    "payment_options": MessageLookupByLibrary.simpleMessage("אפשרויות תשלום"),
    "payment_settings": MessageLookupByLibrary.simpleMessage("הגדרות תשלום"),
    "payment_settings_updated_successfully":
        MessageLookupByLibrary.simpleMessage("הגדרות התשלום עודכנו בהצלחה"),
    "payments_settings": MessageLookupByLibrary.simpleMessage("הגדרות תשלומים"),
    "paypal": MessageLookupByLibrary.simpleMessage("PayPal"),
    "paypal_payment": MessageLookupByLibrary.simpleMessage("תשלום ב-PayPal"),
    ...
    "please_fill_all_fields": MessageLookupByLibrary.simpleMessage(
      "אנא מלא את כל השדות כראוי",
    ),
    "profile": MessageLookupByLibrary.simpleMessage("פרופיל"),
    "profile_settings": MessageLookupByLibrary.simpleMessage("הגדרות פרופיל"),
    "profile_settings_updated_successfully":
        MessageLookupByLibrary.simpleMessage("הגדרות הפרופיל עודכנו בהצלחה"),
    "quantity": MessageLookupByLibrary.simpleMessage("כמות"),
    "razorpay": MessageLookupByLibrary.simpleMessage("RazorPay"),
    "razorpayPayment": MessageLookupByLibrary.simpleMessage("תשלום RazorPay"),
    "recent_orders": MessageLookupByLibrary.simpleMessage("הזמנות אחרונות"),
    "recent_reviews": MessageLookupByLibrary.simpleMessage("ביקורות אחרונות"),
    "recents_search": MessageLookupByLibrary.simpleMessage("חיפושים אחרונים"),
    "register": MessageLookupByLibrary.simpleMessage("הרשמה"),
    "register_successful": MessageLookupByLibrary.simpleMessage(
      "ההרשמה הצליחה",
    ),
    ...
    "restaurants_near_to": MessageLookupByLibrary.simpleMessage("מסעדות בקרבת"),
    "restaurants_near_to_your_current_location":
        MessageLookupByLibrary.simpleMessage("מסעדות בקרבת מקום הנוכחי שלך"),
    "restaurants_results": MessageLookupByLibrary.simpleMessage(
      "תוצאות מסעדות",
    ),
    "reviews": MessageLookupByLibrary.simpleMessage("ביקורות"),
    "reviews_refreshed_successfully": MessageLookupByLibrary.simpleMessage(
      "ביקורות רעננו בהצלחה!",
    ),
    ...
    "select_your_preferred_languages": MessageLookupByLibrary.simpleMessage(
      "בחר את שפת המועדפת עליך",
    ),
    "select_your_preferred_payment_mode": MessageLookupByLibrary.simpleMessage(
    ...
    "smsHasBeenSentTo": MessageLookupByLibrary.simpleMessage(
      "הודעת SMS נשלחה אל",
    ),
    ...
    "this_email_account_exists": MessageLookupByLibrary.simpleMessage(
      "חשבון דוא\"ל זה כבר קיים",
    ),
    "this_food_was_added_to_cart": MessageLookupByLibrary.simpleMessage(
      "המזון הזה נוסף לעגלה",
    ),
    "this_restaurant_is_closed_": MessageLookupByLibrary.simpleMessage(
      "המסעדה הזו סגורה!",
    ),
    "top_restaurants": MessageLookupByLibrary.simpleMessage("מסעדות מובילות"),
    "total": MessageLookupByLibrary.simpleMessage("סה\"כ"),
    "tracking_order": MessageLookupByLibrary.simpleMessage("מעקב אחר ההזמנה"),
    "tracking_refreshed_successfuly": MessageLookupByLibrary.simpleMessage(
      "מעקב רענן בהצלחה",
    ),
    "trending_this_week": MessageLookupByLibrary.simpleMessage("טרנדים השבוע"),
    "typeToStartChat": MessageLookupByLibrary.simpleMessage(
      "הקלד כדי להתחיל בשיחה",
    ),
    "unknown": MessageLookupByLibrary.simpleMessage("לא ידוע"),
    "validCouponCode": MessageLookupByLibrary.simpleMessage("קוד קופון תקף"),
    ...
    "you_must_signin_to_access_to_this_section":
        MessageLookupByLibrary.simpleMessage("עליך להיכנס כדי לגשת לאזור זה"),
