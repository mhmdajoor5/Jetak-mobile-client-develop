...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(error) => "❌ Connection failed: ${error}";

  static String m2(count) => "✅ Success! Notification count: ${count}";
  ...
  static String m7(id) => "Order: #${id} has been canceled";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "testNotificationBody": MessageLookupByLibrary.simpleMessage(
