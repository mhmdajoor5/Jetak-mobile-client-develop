...
class FoodsCarouselItemWidget extends StatelessWidget {
  ...
  FoodsCarouselItemWidget({Key? key, required this.heroTag, required this.marginLeft, required this.food}) : super(key: key);
      ...
      child: Column(
        ...
        children: <Widget>[
          Stack(
            ...
            children: <Widget>[
              ...
              Container(
                ...
                decoration: BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(100)), color: food.discountPrice > 0 ? Colors.red : Theme.of(context).colorScheme.secondary),
                alignment: AlignmentDirectional.topEnd,
                child: Helper.getPrice(food.price, context, style: Theme.of(context).textTheme.bodyLarge?.merge(TextStyle(color: Theme.of(context).primaryColor))),
              ),
            ],
          ),
          SizedBox(height: 5),
          Container(
            ...
            child: Column(
              children: <Widget>[
                Text(this.food.name, overflow: TextOverflow.fade, softWrap: false, style: Theme.of(context).textTheme.bodyMedium),
