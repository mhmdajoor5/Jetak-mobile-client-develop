        ...
        showDialog(
          ...
          builder: (context) {
            return SimpleDialog(
              ...
              title: Row(children: <Widget>[Icon(Icons.person), SizedBox(width: 10), Text(S.of(context).profile_settings, style: Theme.of(context).textTheme.bodyLarge)]),
              children: <Widget>[
                Form(
                  ...
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        ...
                        validator: (input) => input == null || input.trim().length < 3 ? S.of(context).not_a_valid_full_name : null,
                      ...
                      TextFormField(
                        ...
                        validator: (input) => input == null || !input.contains('@') ? S.of(context).not_a_valid_email : null,
                      ...
                      TextFormField(
                        ...
                        validator: (input) => input == null || input.trim().length < 3 ? S.of(context).not_a_valid_phone : null,
                        onSaved: (input) => widget.user.phone = input ?? '',
                        onChanged: (input) {
                          widget.user.updatePhoneVerification(false);
                      ...
                      TextFormField(
                        ...
                        validator: (input) => input == null || input.trim().length < 3 ? S.of(context).not_a_valid_biography : null,
